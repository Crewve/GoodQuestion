...
const RETELLING_EXAMPLE =
  '며느리는 방귀를 참느라 걱정과 불안이 컸고 혼자 고민만 했어요. 참았던 방귀가 크게 터져서 실수한 것 같아 부끄러움을 느꼈고, 가족들도 당황하고 놀람이 컸어요. 배나무 앞에서는 방법을 찾아 지혜를 냈어요. 시아버지는 미안함에 반성하고 사과했고, 며느리를 이해하게 됐어요.'; // post_activity_config.keywords 전부 포함 — ✓ 피드백 확인용
