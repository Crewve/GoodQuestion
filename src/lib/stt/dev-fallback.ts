...
const RETELLING_EXAMPLE =
  '며느리는 방귀 소리가 커서 부끄러움을 느꼈어요. 가족들이 이상하게 볼까 봐 걱정하면서 방귀를 참았어요. 방귀가 터져서 모두 당황했지만, 지혜롭게 방귀로 배를 떨어뜨려 마을 사람들을 도왔고 시아버지도 사과했어요.'; // post_activity_config.keywords(부끄러움·걱정·당황·지혜·사과) 전부 포함 — ✓ 피드백 확인용
