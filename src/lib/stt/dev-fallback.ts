...
const RETELLING_EXAMPLE =
  '며느리는 가족들이 이상하게 볼까 봐 걱정하면서 방귀를 참기만 하고 솔직함을 보이지 못했어요. 참았던 방귀가 터지면서 시아버지의 갓이 날아가 모두 당황했어요. 하지만 배나무 앞에서 지혜를 내어 마을 사람들에게 도움을 주었고, 시아버지는 그 특별한 힘을 알고 사과했어요.'; // post_activity_config.keywords 12개 전부 포함 — ✓ 피드백 확인용
