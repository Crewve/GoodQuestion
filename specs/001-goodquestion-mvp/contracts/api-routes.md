...
| 응답 200 | `{ sessionId, resumeSceneId, resumeSceneOrder, scenes: [{ id, order, type: '도입'\|'전개'\|'대화', description?, characterName?, openingAudioUrl?, imageUrl }], progress: { n, N, percent } }` — 진행률 n/N은 전개+대화 쌍=1(도입 제외) 규칙 |
