...
- [ ] T067 \[P\] (파트1) 재구성 발화 활동 안내 문구 — `src/components/retelling.tsx` 상단에 무엇을 하는 활동인지 안내 타이틀 추가(예: "장면 카드와 핵심 단어를 보고, 이야기를 처음부터 끝까지 말해봐요!"), 아이 화면 최소 18px·Cafe24 Ssurround 준수 (E2E 항목 28. 기획에 안내 요소 누락 — 보완, 안내 음성은 TTS 한도 고려 제외)
