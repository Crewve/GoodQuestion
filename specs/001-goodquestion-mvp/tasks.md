...
- [ ] T072 \[P\] (파트2) 대화 화면 재녹음 버튼 — 보내기 전 STT 결과가 마음에 안 들면 재녹음 가능하게(미션 팝업 포함). T054 재구성 화면의 "재클릭 재녹음 무제한" 패턴을 대화 턴 사이클에 이식 — "보내기 클릭 전까지 어떤 발화도 저장되지 않음" 원칙과 합치 (E2E 항목 13. 기획 무충돌 보완 — 기획 보완 기록 필요)
